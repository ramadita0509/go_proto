...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=go_proto.pb.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x62, 0x22, 0xac, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x12, 0x14,
	...
	0x28, 0x0e, 0x32, 0x18, 0x2e, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x70, 0x62,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: go_proto.pb.Memory.Unit
	(*Memory)(nil),   // 1: go_proto.pb.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: go_proto.pb.Memory.unit:type_name -> go_proto.pb.Memory.Unit
